	...
	<div id="templatemo_header">
    	...
    	<div id="templatemo_menu">
            <ul>
                ...
                <li><a href="#" class="current">Server</a><a href="serverlogin.jsp">Logout</a></li>
            </ul>    	
...
<td  width="182" align="left" valign="middle" height="46"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s4);%></div></td>
            ...
            <p align="right"><a href="allusers.jsp" class="style2">Back</a></p>
        ...
        <div id="templatemo_sidebar">
           ...
           <div id="news_section">
                ...
                <div class="gadget">
                  <p><a href="#">Home </a> </p>
                  <p><a href="serverlogin.jsp">Logout</a></p>
                  <p>&nbsp; </p>
                  <p class="star">&nbsp;</p>
          </div>
		   ...
		   <h2>Performance</h2>
		   <div class="gadget">
          <p class="star">The performance measures include Communication skills,
Inter-personal skills, Problem-solving, Team work,
Adaptability/Flexibility, Initiative, Decision Making,
Leadership, Maturity and Organizational Citizenship Behavior
(OCB). Performance An integrated Domain Driven Data
Mining (D3M) approach using 360° data mining, opinion
mining and SVM based machine learning is rooted in this
research for developing an automated system to enhance the
results of traditional performance evaluation methods for IT
Industries.</p>
          <div class="clr">
