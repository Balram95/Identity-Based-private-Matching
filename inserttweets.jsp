...
<%
					...
					try {
						...
						PreparedStatement ps=connection.prepareStatement("insert into tweets(tname,image,description,date,time,rank) values(?,?,?,?,?,?)");
						ps.setString(1,tname);
						ps.setBinaryStream(2, (InputStream)fs, (int)(file1.length()));	
				//		ps.setString(11,sk);		
			...
			%>
			<p><a href="createtweets.jsp">Back</a>         <a href="servermain.jsp">Home</a> </p>
