	...
	<div id="templatemo_content">
        ...
        <h2>All User Details         </h2>
		 <table width="600" border="3"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse;  margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					<tr>
 						<td  width="120" valign="baseline" height="0" style="color: #2c83b0;"><div align="center"><b>User name</b></div></td>
...
try 
{
	...
	while ( rs.next() )
	{
		...
		//s8=rs.getString(8);
            ...
            <p align="right" class="style2"><a href="servermain.jsp">Back</a></p>
        ...
        <div id="templatemo_sidebar">
           ...
           <div id="news_section">
                ...
                <div class="gadget">
                  <p><a href="allusers.jsp"> All End Users </a> </p>
